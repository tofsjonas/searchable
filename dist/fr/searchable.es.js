...
function a(e) {
  ...
  if (!t) {
    ;((t = document.createElement('input')),
      (t.type = 'search'),
      (t.placeholder = e.dataset.sbPlaceholder ?? i.sbPlaceholder ?? 'Rechercher...'),
...
//#endregion
export {
  a as createSearchAbleInput,
  o as generateRandomId,
  n as generateSearchableDataValues,
  r as handleSearchableInput,
  s as prepareSearchableTable,
  l as searchableEventListener,
  c as toggleSearchable,
}
